...
SELECT DISTINCT
    ...
    CASE WHEN dcd.internal_demand = 'Yes' THEN 'Internal' ELSE 'External' END as internal_demand,
    CASE WHEN dcd.local_demand = 'Yes' THEN 'Local' ELSE 'Non-Local' END as local_demand,
