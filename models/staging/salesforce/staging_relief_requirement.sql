...
SELECT
    ...
    "Is_Local_Demand_c" AS is_local_demand_c,
    "LastReferencedDate" AS last_referenced_date,
    "Name_Of_The_Org__c" AS name_of_the_org,
    "Any_Other_Remark_c" AS any_other_remark,
    "Dispatch_Address__c" AS dispatch_address,
    "No_Of_Individuals_c" AS no_of_individuals,
    ...
    "Name_of_the_Person_c" AS name_of_the_person,
    "Reason_for_urgency_c" AS reason_for_urgency,
